...
const CATEGORIES = [
  "Technology", "AI", "Science", "Business", "Startups", 
  "Finance", "Education", "History", "Sports", "Politics", 
  "Entertainment", "News"
];
    ...
    <div className="w-full max-w-4xl mx-auto px-4 mb-12">
      <div className="flex flex-col gap-4">
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-secondary font-bold text-white tracking-wide">Browse Categories</h2>
        </div>
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          >
            {selected.length === 0 ? (
              <span className="text-white/50 font-sans flex-1">Select categories...</span>
            ) : (
