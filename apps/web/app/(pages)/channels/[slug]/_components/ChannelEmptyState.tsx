    ...
    <section className="w-full max-w-7xl mx-auto px-4 md:px-8 py-24 flex flex-col items-center justify-center text-center">
      ...
      >
        ...
        <div className="relative w-32 h-32 flex items-center justify-center">
          ...
          <div className="absolute inset-4 rounded-full border border-purple-500/10 animate-ping" style={{ animationDuration: '2s', animationDelay: '0.5s' }} />
          {/* Core */}
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-white/40 font-sans text-base leading-relaxed">
            This channel hasn&apos;t published any podcasts yet. Check back soon — great content is on the way.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center gap-3 mt-2">
          ...
          <Link
            ...
            className="flex items-center gap-2 px-5 py-3 rounded-xl bg-white/5 border border-white/10 text-white/60 hover:text-white hover:border-white/25 hover:bg-white/10 font-sans font-semibold text-sm transition-all duration-300"
          >
