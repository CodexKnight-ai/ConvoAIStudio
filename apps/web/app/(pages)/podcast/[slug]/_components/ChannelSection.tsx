    ...
    <div className="flex items-center justify-between gap-4 py-4 border-y border-white/5 my-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className={`px-5 py-2.5 rounded-full font-secondary font-bold text-sm transition-all duration-300 cursor-pointer ${isSubscribed
        ...
        {isSubscribed && (
          <button
            ...
            className={`p-2.5 rounded-full border border-white/10 transition-all cursor-pointer ${notificationsOn
