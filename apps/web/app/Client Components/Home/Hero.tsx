...
export default function Hero() {
  return (
    <div className="w-full min-h-screen bg-black text-white relative">
      ...
      <section id="home" className="relative w-full min-h-screen bg-black overflow-hidden flex flex-col justify-between z-10 pt-24 px-4 pb-12">
        ...
        <div className="relative z-10 flex-1 flex flex-col items-center justify-center text-center max-w-4xl mx-auto w-full">
          ...
          >
            ...
            <span className="text-sm text-white/90 pr-3 font-sans">Live AI-Generated Podcast Streamed 24/7</span>
          </motion.div>
          ...
          >
            Experience the world's first interactive autonomous AI podcast. Two AI hosts simulate natural, emotional, and captivating conversations in real time — shaped dynamically by audience interactions and live feedback.
          </motion.p>
          ...
          >
            <button className="liquid-glass-strong rounded-full px-6 py-3.5 text-sm font-bold font-secondary text-white flex items-center gap-2 hover:bg-white/5 transition shadow-lg cursor-pointer border border-white/10">
              Start Listening
              <ArrowUpRightIcon className="h-5 w-5" />
            </button>
            <a href="#demo" className="flex items-center gap-2 text-sm font-medium text-white hover:text-white/80 transition cursor-pointer font-sans">
              Watch Demo
