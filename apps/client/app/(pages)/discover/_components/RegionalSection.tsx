      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 gap-4">
        ...
        <div className="relative z-20 w-full sm:w-64">
          ...
          >
            ...
            <ChevronDown
              className={`w-4 h-4 text-white/50 transition-transform ${isSelectorOpen ? "rotate-180" : ""}`}
            />
          </button>
      ...
      <div className="relative group">
        ...
        >
          {REGIONAL_PODCASTS.map((podcast) => (
            ...
            >
              <div className="w-full aspect-square rounded-[2rem] overflow-hidden relative mb-4 liquid-glass-strong hover:bg-white/[0.03] transition-colors">
                <img
                  src={podcast.image}
                  alt={podcast.title}
              ...
              <h4 className="text-white font-sans font-medium truncate mb-1 px-2">
                {podcast.title}
              </h4>
              <p className="text-white/60 font-sans text-sm truncate px-2">
                {podcast.creator}
              </p>
            </div>
          ))}
