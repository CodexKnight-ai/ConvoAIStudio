      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 md:px-8 pb-12 pt-16 md:pt-20 flex flex-col items-start gap-6">
        ...
        >
          ...
          <MetaStat
            ...
            value={channel.totalPodcasts.toString()}
            label="Podcasts"
          />
          <span className="w-px h-5 bg-white/15 hidden sm:block" />
          <MetaStat
            icon={<CalendarDays className="w-4 h-4 text-blue-400" />}
            value={channel.joinedDate}
            label="Joined"
          />
        </motion.div>
        ...
        >
          ...
          {subscribed && (
            <motion.button
              ...
              className={`flex items-center justify-center w-11 h-11 rounded-xl transition-all duration-300 cursor-pointer ${
                notifications
            ...
            >
              {notifications ? (
                <Bell className="w-4 h-4 fill-cyan-400" />
              ) : (
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-3 rounded-xl bg-white/5 text-white/60 hover:text-white hover:bg-white/10 text-sm font-sans font-semibold transition-all duration-300 cursor-pointer"
          >
