  ...
  return (
    <div className="relative w-full flex flex-col items-center justify-center py-20 px-4 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        {/* Slow orbiting dots */}
        <div className="absolute top-[15%] left-[10%] w-2 h-2 rounded-full bg-cyan-500/30 animate-pulse" />
        <div className="absolute top-[25%] right-[15%] w-1.5 h-1.5 rounded-full bg-purple-500/30 animate-pulse" style={{ animationDelay: '1s' }} />
        <div className="absolute bottom-[20%] left-[20%] w-1 h-1 rounded-full bg-blue-400/40 animate-pulse" style={{ animationDelay: '0.5s' }} />
        <div className="absolute top-[40%] right-[8%] w-2.5 h-2.5 rounded-full bg-cyan-400/20 animate-pulse" style={{ animationDelay: '1.5s' }} />
        <div className="absolute bottom-[30%] right-[25%] w-1.5 h-1.5 rounded-full bg-purple-400/25 animate-pulse" style={{ animationDelay: '2s' }} />
      ...
      >
        &ldquo;Follow creators, discover live discussions, and never miss an upcoming AI-powered conversation.&rdquo;
      </motion.p>
