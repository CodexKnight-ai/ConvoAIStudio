        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
              {socials.map((social) => (
                <a
                  ...
                  className={`flex flex-col items-center justify-center gap-2 p-4 rounded-2xl bg-white/5 text-white/70 transition-all duration-300 ${social.color}`}
                >
                  {social.icon}
            ...
            <div className="flex flex-col gap-2">
              <span className="text-xs font-sans font-semibold text-white/50">
                Direct Link
              </span>
              <div className="flex items-center gap-2 p-1 rounded-2xl bg-white/5">
                <input
                  type="text"
                  readOnly
                  value={shareUrl}
