...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen flex bg-gray-950">
      ...
      <BeamsBackground heading="Welcome to ConvoAI Studio" subheading="Create your account to explore new dimension of futuristic podcasts !!!" />
      </div>
      ...
      <div className="w-full py-20 lg:w-1/2 bg-gray-950 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="text-center mb-10">
            <h1 className="text-3xl font-bold text-white mb-2 font-secondary">Create Account</h1>
            ...
            <div className="flex items-start">
              <div className="flex items-center h-5">
                <input
                  ...
                  onChange={handleChange}
                  className="focus:ring-cyan-500 h-4 w-4 text-cyan-600 border-gray-600 rounded bg-gray-800"
                />
              </div>
