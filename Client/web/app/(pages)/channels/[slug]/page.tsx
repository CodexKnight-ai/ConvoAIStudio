    ...
    <div className="animate-pulse">
      ...
      <div className="w-full max-w-7xl mx-auto px-4 md:px-8 py-12 flex flex-col gap-10">
        <div className="grid grid-cols-2 gap-6">
          {[...Array(4)].map((_, i) => (
            <div key={i} className="rounded-2xl bg-white/[0.03] border border-white/6 overflow-hidden">
    ...
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-4">
      <div className="text-center space-y-4 max-w-md">
        ...
        <p className="text-white/40 font-sans">
          The channel &quot;{slug}&quot; doesn&apos;t exist or may have been removed.
        </p>
        <Link
          href="/channels"
...
export default function ChannelPage({ params }: PageProps) {
  ...
  const [channel, setChannel] = useState<ChannelData | null | undefined>(undefined);
