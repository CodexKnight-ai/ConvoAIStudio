...
graph 
subgraph Clients
    Web["Next.js 16<br/>React 19 + Apollo Client"]
end
...
subgraph API["API Gateway :4000"]
    GW["Fastify<br/>REST + GraphQL<br/>JWT Auth<br/>Rate Limiting<br/>Circuit Breaker"]
end
...
subgraph Core["Core Services"]
    Auth["Auth Service :4001<br/>JWT + RBAC"]
    Podcast["Podcast Service :4002<br/>Channels + Metadata<br/>pgvector Search"]
    Realtime["Realtime Service :4003<br/>WebSocket/WebRTC"]
end
...
subgraph AI["AI Services"]
    GRPC["gRPC Bridge :50051"]
    AIEngine["Python FastAPI :5000<br/>LangChain + LLM"]
end
...
subgraph Media["Media Services"]
    Storage["Storage Service :4004<br/>S3 Orchestration"]
    Transcoder["Transcoding Service :4005<br/>FFmpeg Workers"]
end
...
subgraph Platform["Platform Services"]
    Notify["Notification Service :4007"]
    Telemetry["Telemetry Service :4006"]
end
...
subgraph Queue["Async Processing"]
    BullMQ["BullMQ"]
    Workers["Background Workers<br/>Transcription<br/>Analytics<br/>Clips<br/>Email"]
end
...
subgraph Data["Persistence Layer"]
    PG["PostgreSQL 16<br/>auth_db + podcast_db<br/>pgvector"]
    Redis["Redis Cluster<br/>Cache + Pub/Sub + Sessions"]
    S3["S3 / MinIO"]
end
